...
namespace ProjectOcelot.Menues
{
	public class CustomMatchSettingsMenu : Menu
	{
		...
		[HideInInspector]
		public Match.MatchType MatchTypeSetting;
		...
		{
			// Set the match type
			MatchTypeSetting = Match.MatchType.CustomClassic;
		...
		public void BeginMatch ( )
		{
			...
			if ( ValidateCustomMatchSettings ( ) )
			{
				...
				// Set match settings
				Match.MatchSettings.SetMatchSettings ( MatchTypeSetting, EnableTurnTimerSetting, TimePerTurnSetting, HeroesPerTeamSetting, HeroLimitSetting, HeroSettings );
