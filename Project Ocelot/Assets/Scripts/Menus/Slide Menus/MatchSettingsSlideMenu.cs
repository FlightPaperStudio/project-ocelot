...
namespace ProjectOcelot.Menues
{
	public class MatchSettingsSlideMenu : SlideMenu
	{
		...
		[SerializeField]
		private UI.CarouselButton matchTypeCarousel;

		[SerializeField]
		private UI.CarouselButton turnTimerCarousel;
		...
		public void UpdateMatchType ( )
		{
			...
			{
			case 0:
				customSettingsManager.MatchTypeSetting = Match.MatchType.CustomClassic;
				break;
			case 1:
				customSettingsManager.MatchTypeSetting = Match.MatchType.CustomInferno;
				break;
			case 2:
				customSettingsManager.MatchTypeSetting = Match.MatchType.CustomRumble;
				break;
			}
		}
