...
namespace ProjectOcelot.Database
{
	public class StatusEffectDatabase
	{
		...
		public static Units.StatusEffects.Effect GetStatusEffect ( StatusEffectType status )
		{
			// Store status data
			Units.StatusEffects.Effect effect = null;
			IDataReader data;
			...
			while ( data.Read ( ) )
				effect = new Units.StatusEffects.Effect
				{
