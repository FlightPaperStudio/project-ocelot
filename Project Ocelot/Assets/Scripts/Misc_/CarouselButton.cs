...
namespace ProjectOcelot.UI
{
	public class CarouselButton : MonoBehaviour
	{
		...
		/// <summary>
		/// Sets the list of options for this carousel.
		/// </summary>
		/// <param name="newOptions"> The new list of options. </param>
		/// <param name="index"> The default index for the new options. </param>
		public void InitializeOptions ( string [ ] newOptions, int index = 0 )
		{
			// Store options
			options = newOptions;

			// Set carousel
			SetOption ( index, false );
		}
