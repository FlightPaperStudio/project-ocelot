...
namespace ProjectOcelot.Match.HUD
{
	public class UnitHUD : MonoBehaviour
	{
		...
		[SerializeField]
		private UI.UnitPortrait portrait;
		...
		public void DisplayUnit ( Units.Unit u, bool displayControls = true )
		{
			// Store current unit
			currentUnit = u;
		...
		public void UseCommand ( int position )
		{
			...
			// Start the command
			( currentUnit as Units.HeroUnit ).StartCommand ( ability );
		...
		public void CancelCommand ( int position )
		{
			...
			// End the command
			( currentUnit as Units.HeroUnit ).CancelCommand ( );
		...
		public void DisableCommandButtons ( )
		{
			...
			if ( currentUnit is Units.HeroUnit )
			{
		...
		private void DisplayAbilityHUD ( AbilityInstanceData ability, AbilityHUD hud, bool displayControls )
		{
			...
			// Set team colors
			hud.CooldownDisplay.color = Tools.Util.TeamColor ( currentUnit.Owner.Team );
			hud.ActiveDisplay.color = Tools.Util.AccentColor ( currentUnit.Owner.Team );
