	...
	public class Tile : MonoBehaviour
	{
		...
		private Color32 GetColor ( TileState state )
		{
			...
			case TileState.Default:
				return new Color32 ( 200, 200, 200, 255 ); // Light grey
			case TileState.AvailableUnit:
				return new Color32 ( 255, 255, 200, 255 ); // Light yellow
			case TileState.AvailableUnitHover:
				return new Color32 ( 255, 210, 75, 255 ); // Gold
			case TileState.SelectedUnit:
				return new Color32 ( 255, 210, 75, 255 ); // Gold
			case TileState.AvailableMove:
				return new Color32 ( 150, 255, 255, 255 ); // Light cyan
			case TileState.AvailableMoveHover:
				return new Color32 ( 0, 165, 255, 255 ); // Dark cyan
			case TileState.SelectedMove:
				return new Color32 ( 0, 165, 255, 255 ); // Dark cyan
			case TileState.AvailableMoveAttack:
				return new Color32 ( 150, 255, 255, 255 ); // Light cyan
			case TileState.AvailableMoveAttackHover:
				return new Color32 ( 0, 165, 255, 255 ); // Dark cyan
			case TileState.SelectedMoveAttack:
				return new Color32 ( 0, 165, 255, 255 ); // Dark cyan
			case TileState.AvailableAttack:
				return new Color32 ( 255, 150, 150, 255 ); // Light red
			case TileState.AvailableAttackHover:
				return new Color32 ( 200, 50, 50, 255 ); // Dark red
			case TileState.SelectedAttack:
				return new Color32 ( 200, 50, 50, 255 ); // Dark red
			case TileState.AvailableSpecial:
				return new Color32 ( 255, 125, 255, 255 ); // Light purple
			case TileState.AvailableSpecialHover:
				return new Color32 ( 125, 0, 125, 255 ); // Purple
			case TileState.SelectedSpecial:
				return new Color32 ( 125, 0, 125, 255 ); // Purple
			case TileState.AvailableSpecialAttack:
				return new Color32 ( 255, 125, 255, 255 ); // Light purple
			case TileState.AvailableSpecialAttackHover:
				return new Color32 ( 125, 0, 125, 255 ); // Purple
			case TileState.SelectedSpecialAttack:
				return new Color32 ( 125, 0, 125, 255 ); // Purple
			case TileState.AvailableCommand:
				return new Color32 ( 255, 125, 255, 255 ); // Light purple
			case TileState.AvailableCommandHover:
				return new Color32 ( 125, 0, 125, 255 ); // Purple
			case TileState.SelectedCommand:
				return new Color32 ( 125, 0, 125, 255 ); // Purple
			case TileState.ConflictedTile:
				return new Color32 ( 202, 190, 255, 255 ); // Light lavender
			case TileState.ConflictedTileHover:
				return new Color32 ( 130, 130, 255, 255 ); // Dark lavender
			default:
				return new Color32 ( 200, 200, 200, 255 ); // Light grey
			}
		}
