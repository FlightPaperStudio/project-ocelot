...
namespace ProjectOcelot.Match
{
	public class Player : MonoBehaviour
	{
		...
		public Arena.EntranceArea Entrance;
		public Arena.ObjectiveArea Objective;
		public List<UnitSettingData> Units = new List<UnitSettingData> ( );
		public List<Units.Unit> UnitInstances = new List<Units.Unit> ( );
		public List<int> StarterInstanceIDs = new List<int> ( );
		public Units.Unit.KOdelegate StandardKOdelegate;
		public List<Arena.TileObject> TileObjects = new List<Arena.TileObject> ( );
