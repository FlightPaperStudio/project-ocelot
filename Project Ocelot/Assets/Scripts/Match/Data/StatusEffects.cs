...
namespace ProjectOcelot.Units
{
	public class StatusEffects
	{
		...
		public void AddStatusEffect ( Database.StatusEffectDatabase.StatusEffectType effect, int duration, Unit caster )
		{
			...
			else
			{
				...
				Effect statusEffect = Database.StatusEffectDatabase.GetStatusEffect ( effect );
		...
		public void RemoveStatusEffect ( Database.StatusEffectDatabase.StatusEffectType effect, Unit caster )
		{
			// Check if the status effect is already present
			if ( Effects.Exists ( x => x.ID == (int)effect && x.Caster == caster ) )
			{
		...
		public bool HasStatusEffect ( Database.StatusEffectDatabase.StatusEffectType effect )
		{
		...
		/// <returns> Whether or not the unit has the status effect applied. </returns>
		public bool HasStatusEffect ( Database.StatusEffectDatabase.StatusEffectType effect, Unit caster )
		{
			// Check for the status effect
