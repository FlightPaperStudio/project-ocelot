...
namespace ProjectOcelot.Match.Arena
{
	public class TileObject : MonoBehaviour
	{
		...
		/// </summary>
		public void SetTileObject ( Units.HeroUnit caster, Hex hex, int objDuration, TileObjectDelegate durationDel, TileObjectDelegate attackDel = null )
		{
			// Set owner
			Caster = caster;
		...
		public bool UnitAttackCheck ( Units.Unit attacker, bool friendlyFire = false )
		{
